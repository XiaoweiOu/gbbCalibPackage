...
condor_submit FILEDIR=${FILEPATH_STUB} DO_MCONLY=1 scripts/HTCscripts/hadd_batch.sub



#2-sided-systematics
#JET_Rtrk_Baseline_Kin JET_Rtrk_Modelling_Kin JET_Rtrk_Tracking_Kin JET_Rtrk_TotalStat_Kin JET_Rtrk_Baseline_Sub JET_Rtrk_Modelling_Sub JET_Rtrk_Tracking_Sub JET_Rtrk_TotalStat_Sub 

#MUON_ID MUON_MS MUON_SCALE MUON_SAGITTA_RESBIAS MUON_SAGITTA_RHO MUON_EFF_STAT MUON_EFF_SYS MUON_EFF_STAT_LOWPT MUON_EFF_SYS_LOWPT MUON_TTVA_STAT MUON_TTVA_SYS JET_Rtrk_Baseline_Kin JET_Rtrk_Modelling_Kin JET_Rtrk_Tracking_Kin JET_Rtrk_TotalStat_Kin JET_Rtrk_Baseline_Sub JET_Rtrk_Modelling_Sub JET_Rtrk_Tracking_Sub JET_Rtrk_TotalStat_Sub 

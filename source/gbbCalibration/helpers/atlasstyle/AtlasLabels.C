...
void ATLASLabel(Double_t x,Double_t y,char const* text,Color_t color) 
{
  ...
  double delx = 0.11;//0.115*696*gPad->GetWh()/(472*gPad->GetWw());
...
void ATLASLabel2(Double_t x,Double_t y,char const* text,Color_t color) 
{
  TLatex l; //l.SetTextAlign(12); l.SetTextSize(tsize); 
  l.SetNDC();
  l.SetTextFont(72);
...
void ATLASLabel3(Double_t x,Double_t y,char const* text,Color_t color) 
{
  TLatex l; //l.SetTextAlign(12); l.SetTextSize(tsize); 
  l.SetNDC();
  l.SetTextFont(72);
  l.SetTextColor(color);
  double delx = 0.16;//0.115*696*gPad->GetWh()/(472*gPad->GetWw());

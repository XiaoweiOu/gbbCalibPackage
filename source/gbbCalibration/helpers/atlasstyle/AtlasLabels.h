...
void ATLASLabel(Double_t x,Double_t y,char const* text=NULL,Color_t color=1); 
void ATLASLabel2(Double_t x,Double_t y,char const* text=NULL,Color_t color=1); 
void ATLASLabel3(Double_t x,Double_t y,char const* text=NULL,Color_t color=1); 

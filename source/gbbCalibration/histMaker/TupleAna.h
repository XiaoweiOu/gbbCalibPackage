...
// Mon Mar  9 06:43:08 2020 by ROOT version 6.16/00
// from TTree FlavourTagging_Nominal/FlavourTagging_Nominal
// found on file: /xrootdfs/atlas/dq2/rucio/user/aemerman/d6/d6/user.aemerman.20712439._000023.tuple.root
//////////////////////////////////////////////////////////
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   vector<float>   *trkjet_SV1_efracsvx;
   vector<int>     *trkjet_SV1_NGTinSvx;
   vector<int>     *trkjet_truth;
   vector<int>     *trkjet_nTrks;
   vector<int>     *trkjet_nGoodTrks;
   vector<float>   *trkjet_meanSd0;
   ...
   TBranch        *b_trkjet_SV1_efracsvx;   //!
   TBranch        *b_trkjet_SV1_NGTinSvx;   //!
   TBranch        *b_trkjet_truth;   //!
   TBranch        *b_trkjet_nTrks;   //!
   TBranch        *b_trkjet_nGoodTrks;   //!
   TBranch        *b_trkjet_meanSd0;   //!
...
void TupleAna::Init(TTree *tree, TString sysName)
{
   ...
   trkjet_SV1_efracsvx = 0;
   trkjet_SV1_NGTinSvx = 0;
   trkjet_truth = 0;
   trkjet_nTrks = 0;
   trkjet_nGoodTrks = 0;
   trkjet_meanSd0 = 0;
   ...
   fChain->SetBranchAddress("eve_ps_w_sys", &eve_ps_w_sys, &b_eve_ps_w_sys);
   ...
   fChain->SetBranchAddress("trkjet_SV1_efracsvx", &trkjet_SV1_efracsvx, &b_trkjet_SV1_efracsvx);
   fChain->SetBranchAddress("trkjet_SV1_NGTinSvx", &trkjet_SV1_NGTinSvx, &b_trkjet_SV1_NGTinSvx);
   ...
   fChain->SetBranchAddress("trkjet_nGoodTrks", &trkjet_nGoodTrks, &b_trkjet_nGoodTrks);
   fChain->SetBranchAddress("trkjet_meanSd0", &trkjet_meanSd0, &b_trkjet_meanSd0);

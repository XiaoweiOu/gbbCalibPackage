...
private:
  ...
  typedef enum {
    ...
    FILL_BASIC_PROPERTIES = 0x002,
    FILL_ADV_PROPERTIES = 0x004,
    FILL_REWEIGHT = 0x010,
    FILL_TRIGGER = 0x020,
  ...
  //
  TString getTriJetFlav(GbbCandidate* gbbcand);
  ...
  TString makePtInclTrkJetPlotName(GbbCandidate* gbbcand, unsigned int i, const TString var);
  TString makePtInclPlotName(GbbCandidate* gbbcand, const TString var);
  TString makeInclPlotName(const TString var);
  ...
  void FillXbbProperties(GbbCandidate* gbbcand, float event_weight,TString nametag="");
  void FillMuonProperties(GbbCandidate* gbbcand, float event_weight, TString nametag="");
  void FillTrackProperties(GbbCandidate* gbbcand, float event_weight, TString nametag="");

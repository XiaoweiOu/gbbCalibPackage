...
if( NOT WorkDir_FIND_QUIETLY )
   message( STATUS "Found WorkDir: "
      "${WorkDir_ROOT_DIR} (version: 21.2.83)" )
endif()
...
set( WorkDir_BASE_PROJECTS AnalysisBase;21.2.83 )
...
set( ATLAS_PLATFORM generic )

# Packages provided by the project:
set( WorkDir_PACKAGE_NAMES CommonSystSmoothingTool;gbbCalibration )
...
if( WorkDir_FIND_COMPONENTS )
   ...
   if( ATLAS_RELEASE_RECOMPILE )
      ...
      set( WorkDir_TARGET_NAMES CommonSystSmoothingToolPkg;CommonSystSmoothingToolPkgPrivate;CommonSystSmoothingToolLib;testSmooth;testInputFile;gbbCalibrationPkg;gbbCalibrationPkgPrivate;gbbCommonLib;gbbTupleLib;ScaleFactorCalcLib;run_gbbTupleAna;run_calculateSF )
